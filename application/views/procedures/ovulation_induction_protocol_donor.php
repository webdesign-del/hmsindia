...
$patient_id = $select_result8['patient_id'];
    ...
    if(isset($_POST['submit'])){
        ...
        $select_query = "SELECT * FROM `ovulation_induction_protocol` WHERE patient_id='$patient_id'";
...
<table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">OVULATION INDUCTION PROTOCOL</h3></td>
   </tr>
</table>
...
<div  class="printtable prtable"  id="printtable"  style="display:none">  
   ...
   <td colspan="2" style="border:1px solid #cdcdcd;"><h2>OVULATION INDUCTION PROTOCOL</h2></td>
</tr>
		<tr style="text-align: center; color: red; ">
