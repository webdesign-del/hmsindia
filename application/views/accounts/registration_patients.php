 ...
 <div class="card">
      ...
      <div class="col-md-12"><h3> Registration Patients </h3></div>
      <div class="clearfix"></div>
	    <form action="<?php echo base_url().'accounts/registration_patients'; ?>" method="get">
		   <div class="col-sm-3 col-xs-12" style="margin-top:10px;">
            ...
            <div class="col-sm-1" style="margin-top: 10px;">
            	<a href="<?php echo base_url().'accounts/registration_patients'; ?>" style="text-decoration: none;">
                <button name="btnreset" id="btnreset" type="button"  class="btn btn-secondary">RESET</button>
               </a>
            </div>
            <div class="col-sm-2" style="margin-top: 10px;">
            	<a href="<?php echo base_url('accounts/Registration-patients'); ?>" style="text-decoration: none;">
        ...
        <div class="card-content">
          <div class="table-responsive">
            ...
            <table class="table table-sriped table-bordered table-hover" id="consultation_billing_list">
              ...
              <tbody id="registration_result">
              <?php $count=1; 
					foreach($registration_result as $ky => $vl){
    ...
    function approveRegistation(ID) {
        if (confirm('Are you sure you want to approve this order?')) {
            $.ajax({
                url: '<?php echo base_url('accounts/approve_registation/'); ?>' + ID,
