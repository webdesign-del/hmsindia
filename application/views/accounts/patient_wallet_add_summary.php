...
<div class="card">
    ...
    <div class="box-body">
        <form method="GET" action="<?= base_url('accounts/patient_wallet_add_summary') ?>" class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <a href="<?= base_url('accounts/patient_wallet_add_summary/true?').$_SERVER['QUERY_STRING'] ?>" class="btn btn-success"><i class="fa fa-download"></i> Export</a>
            </div>
        </form>
