...
$select_query8 = "SELECT * FROM `hms_opd_assessment` WHERE patient_id='$patient_id'";
            ...
            <div class="card animate-in">
                ...
                <div class="card-content">
                    <form method="post" action="" enctype="multipart/form-data" id="opdForm"  class="form-grid space-y-4">
                        <input type="hidden" name="patient_id" id="patient_id" value="<?php echo $select_result8['patient_id']; ?>">
                        <!-- Patient & Visit Information -->
                        <section class="form-grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="form-group">
                                <label class="label required" for="name">Patient Name</label>
                                <input type="text" value="<?php echo $select_result8['name']; ?>" id="name" class="input" readonly="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $select_result8['spouse_name']; ?>" id="spouse_name" class="input" readonly="">
                            </div>
                            
                            <div class="form-group">
                                <label class="label" for="city">City</label>
                                <input type="text" value="<?php echo $select_result8['city']; ?>"  id="city" class="input" readonly="">
                            </div>
                            
                            <div class="form-group">
                                <label class="label" for="age">Patient Age</label>
                                <input type="number" value="<?php echo $select_result8['patient_age']; ?>" name="patient_age" class="input" readonly="">
                                <div class="error-message text-xs text-danger hidden" id="age-error"></div>
                            </div>
                            <div class="form-group">
                                <label class="label" for="age">Spouse Age</label>
                                <input type="number" value="<?php echo $select_result8['spouse_age']; ?>" name="spouse_age" class="input" readonly="">
                                <div class="error-message text-xs text-danger hidden" id="age-error"></div>
                            </div>

                            <div class="form-group">
                                <label class="label required" for="name">Keyword / Case Tag</label>
                                <input type="text" value="<?php echo $select_result8['keyword']; ?>" name="keyword" class="input" readonly="">
    ...
    <div class="radio-group grid-cols-2">
        <label class="radio-item">
            <input type="radio" name="infertilityType" value="Primary" class="radio-input" 
                   <?php echo (!isset($infertilityType) || $infertilityType == 'Primary') ? 'checked' : ''; ?>>
            Primary
        </label>
        <label class="radio-item">
            <input type="radio" name="infertilityType" value="Secondary" class="radio-input" 
                   <?php echo (isset($infertilityType) && $infertilityType == 'Secondary') ? 'checked' : ''; ?>>
            Secondary
        </label>
    </div>
</div>
                            ...
                            <div class="form-group md:col-span-2">
                                ...
                                <input type="text" value="<?php echo $select_result8['menstruationHistory']; ?>"  name="menstruationHistory" class="input" readonly="">
                            </div>
                            
                            <div class="form-group">
                                <label class="label" for="lmp">LMP</label>
                                <input type="date" value="<?php echo $select_result8['lmp']; ?>"  name="lmp" readonly="" class="input">
                            </div>
                        </section>
                        ...
                        <section class="form-grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-group">
                                ...
                                <textarea id="past_medical_history" name="past_medical_history" class="textarea" readonly=""><?php echo $select_result8['past_medical_history']; ?></textarea>
                            </div>
                            
                            <div class="form-group">
                                <label class="label" for="pastSurgicalHistory">Past Surgical History</label>
                                <textarea id="past_surgical_history" name="past_surgical_history" class="textarea" readonly=""><?php echo $select_result8['past_surgical_history']; ?></textarea>
                            </div>
                        </section>
    ...
    <label class="checkbox-item">
        ...
        Semen Analysis
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo $select_result8['investigation_other']; ?>" id="investigation_other" class="input" readonly="">
                            </div>
                        </section>
    ...
    <label class="checkbox-item">
        ...
        Unexplained infertility
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo $select_result8['diagnosis_other']; ?>" id="diagnosis_other" class="input" readonly="">
    ...
    <label class="checkbox-item">
        ...
        Surgical
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="reason" name="reason" class="textarea" readonly=""><?php echo $select_result8['reason']; ?></textarea>
                                </div>
                            </div>
                        </section>
                        ...
                        <section class="form-grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="form-group md:col-span-2">
                                ...
                                <textarea id="advice" name="advice" class="textarea" readonly=""><?php echo $select_result8['advice']; ?></textarea>
                            </div>
                            
                            <div class="form-group">
                                <label class="label">Next Follow-up On</label>
                                <input type="date" id="next_follow_up" value="<?php echo $select_result8['next_follow_up']; ?>" class="input mb-2" readonly="">
                                <input type="time" id="nextFollowUpTime" value="<?php echo $select_result8['nextFollowUpTime']; ?>" name="nextFollowUpTime" class="input" readonly="">
                        ...
                        <section class="form-grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="counsellor_name" name="counsellor_name" value="<?php echo $select_result8['counsellor_name']; ?>" class="input" readonly="">
                            </div>
                        </section>
                    </form>
                </div>
