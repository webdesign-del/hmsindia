...
<input type="hidden" value="<?php echo $updated_at; ?>" class="form" name="updated_at">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">UTERINE PRP SECOND CYCLE</h3></td>
   </tr>
</table>
 <table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
<tbody>
...
<table  id="printtable" border="1">
             ...
             <table class="table-bordered" style="width:100%; border:1px solid #cdcdcd;">
	            <tr>
					...
					<td width="50%" colspan="2" style="border:1px solid #cdcdcd;text-align:center"><h2><strong>UTERINE PRP SECOND CYCLE</strong></h2></td>
				</tr>
				</table>
