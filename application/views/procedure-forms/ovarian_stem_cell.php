...
<table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">OVARIAN STEM CELL</h3></td>
   </tr>
</table>
...
<strong>IIC ID: <?php echo $patient_id; ?></strong>
							...
							<table class="table-bordered" width="100%">
								...
								<tr style="color: red;">
									...
									<td colspan="2">Allergies<br><input   type="text" value="<?php echo isset($select_result['allergies'])?$select_result['allergies']:""; ?>"     maxlength="50" name="allergies" class="form-control" ></td>
									<td>
										Consent<br>
							...
							<table style="color: red;" class="table-bordered" width="100%">
								<tr>
									...
									<td>
										<p>Written informed consent taken . All vitals under normal range. The anesthetist examined the patient and gave general anesthesia .Under all sterile conditions . Patient put in lithotomy position . Jamshedi needle introduced in iliac crest  . 20 ml of stem cell was drawn from syringe ,triple centrifuged by bone marrow processing system for 25 -30 min. , the vulva and vagina were cleansed by betadine and draped. A condom with lubricated jelly is put on the vaginal ultrasound probe,it is introduced transvaginally ,a baseline transvaginal ultrasound performed to see endometrium and ovaries. The supernatant pellet 3ml was infused bilaterally intraovarian by single lumen needle under transvaginal ultrasound guidance with multiple punctures under anesthesia.</p>
...
<tr>
			 ...
			 <td width="50%" colspan="2" style="border:1px solid #cdcdcd;"><center><h2>OVARIAN STEM CELL</h2></center></td>
