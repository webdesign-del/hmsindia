<?php
    ...
    if(isset($_POST['submit'])){
        unset($_POST['submit']);
        $select_query = "SELECT * FROM `hms_oocyte_freezing_discharge` WHERE patient_id='$patient_id' and receipt_number='$receipt_number'";
        ...
        if(empty($select_result)){
            ...
            $query = "UPDATE hms_oocyte_freezing_discharge SET ";
            foreach( $_POST as $key=> $value )
            {
              $sqlArr[] = " $key = '".$value."'"	;
            }
...
<div class="container2 red-field form mt-5 mb-5">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><?php 
                ...
                <?php endif; ?></td>
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">Oocyte Freezing Dischrge Summary</h3></td>
   </tr>
</table>
<div class="ga-pro">
