...
<table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">PSYCHOLOGICAL EVALUATION SHEET THIRD CYCLE</h3></td>
   </tr>
</table>
...
<strong>IIC ID: <?php echo $patient_id; ?></strong>
			...
			<input type="text" maxlength="50" name="type" class="form-control" value="Third Cycle">
