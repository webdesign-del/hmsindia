<?php
	...
	$query_oocyte_freezing = "SELECT * FROM `hms_oocyte_freezing` WHERE patient_id='$patient_id' and type='First Cycle'";
...
<input type="hidden" value="<?php echo $updated_at; ?>" class="form" name="updated_at">
  ...
  <input type="hidden" value="First Cycle" name="type"> 
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">OOCYTE THAWING</h3></td>
   </tr>
</table>
