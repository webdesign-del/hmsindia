...
<table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">TRANSVAGINAL OVARIAN EXOSOMES THERAPHY</h3></td>
   </tr>
</table>
							...
							<table style="color: red;" class="table-bordered" width="100%">
								<tr>
									...
									<td>
										...
										<p>Written informed consent was obtained. All vital parameters were within normal limits. 20ml of blood was drawn for exosome preparation using an exosome preparation kit, as per protocol. The anesthetist evaluated the patient and administered general anesthesia.</p>

										<p>Under strict aseptic and sterile precautions, the patient was placed in the lithotomy position. The vulva and vagina were cleansed with betadine solution and sterile draping was done. A transvaginal ultrasound probe covered with a condom and lubricated jelly was introduced vaginally. A baseline transvaginal ultrasound was performed to assess the uterus, endometrium, and both ovaries.</p>

										<p>The prepared exosome solution was loaded into a syringe. Under continuous transvaginal ultrasound guidance, the exosomes were infused bilaterally into the ovaries using a single-lumen ovum pickup needle under anesthesia.</p>

										<p>No intra-procedural complications were noted. After completion of the infusion, the transvaginal probe was removed and hemostasis was ensured. The patient tolerated the procedure well and was shifted to recovery in stable condition.</p>

										<p><input   type="text" value="<?php echo isset($select_result['abdominal'])?$select_result['abdominal']:""; ?>"     name="abdominal"></p>
									</td>
								</tr>
							</table>
							<table style="color: red;" class="table-bordered" width="100%">
...
<tr>
			 ...
			 <td width="50%" colspan="2" style="border:1px solid #cdcdcd;"><center><h2>TRANSVAGINAL OVARIAN EXOSOMES THERAPHY</h2></center></td>
