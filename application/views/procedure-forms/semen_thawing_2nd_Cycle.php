<?php
	...
	$sql_semen_freezing = "Select * from ".$this->config->item('db_prefix')."semen_freezing where patient_id='".$patient_id."' AND type='Second Cycle'";
...
<input type="hidden" value="Second Cycle" name="type">  
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">SEMEN THAWING SECOND CYCLE</h3></td>
   </tr>
</table>
