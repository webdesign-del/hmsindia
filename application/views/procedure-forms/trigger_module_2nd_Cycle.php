...
<input type="hidden" value="Second Cycle" class="form" name="type">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">TRIGGER SECOND CYCLE</h3></td>
   </tr>
</table>
...
<div  class="printtable prtable"  id="printtable" style="display:none;"> <input type="button" id="btn" value="Print" class="btn btn-primary pull-right ptable">
