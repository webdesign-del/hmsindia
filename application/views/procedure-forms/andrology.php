...
<div class="printtable prtable" id="master_print_wrapper" style="display:none">  
  <table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
       <tr>
           <td style="width:50%;padding:5px;" colspan="10"><img src="<?php echo base_url(); ?>/assets/images/India-IVF-Logo-Option-5.png" style="width:220px"></td>
           <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">ANDROLOGY</h3></td>
  ...
  <table style="width:100%; border:1px solid #cdcdcd;" border="1">
     <thead>
        <tr>
            <td colspan="4" style="border:1px solid #cdcdcd;">
                <?php if(isset($select_result['updated_by']) && !empty($select_result['updated_by'])){ ?>
                    <p>Last updated on <?php echo $select_result['updated_at']; ?></p>
                <?php } ?>
            </td>
        </tr>           
        <tr><th colspan="4" style="text-align:center;border:1px solid #cdcdcd;">SEMEN EXAMINATION</th></tr>
     </thead> 
     <tbody>
            <tr>
                <td style="border:1px solid #cdcdcd; font-weight:bold;">Physical Examination</td>
                <td style="border:1px solid #cdcdcd; font-weight:bold;">VALUES</td>
                <td style="border:1px solid #cdcdcd; font-weight:bold;">UNIT</td>
                <td style="border:1px solid #cdcdcd; font-weight:bold;">REF RANGE</td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4" style="border:1px solid #cdcdcd; font-weight:bold; background:#f2f2f2;">Microscopic Examination</td>
            </tr>
            <tr>
                <td style="border:1px solid #cdcdcd;">Total sperm concentration</td>
                <td style="border:1px solid #cdcdcd;"><?php echo isset($select_result['tsc'])?$select_result['tsc']:""; ?></td>
            ...
            <tr>
                <td colspan="4" style="border:1px solid #cdcdcd; font-weight:bold; background:#f2f2f2;">Morphology</td>
            </tr>
            <tr>
                <td style="border:1px solid #cdcdcd;">Normal Morphology</td>
                <td style="border:1px solid #cdcdcd;"><?php echo isset($select_result['normal_morphology'])?$select_result['normal_morphology']:""; ?></td>
                <td style="border:1px solid #cdcdcd;">%</td>
            ...
            <tr>
                <td colspan="4" style="border:1px solid #cdcdcd; font-weight:bold; background:#f2f2f2;">Chemical Examination</td>
            </tr>
            <tr>
                <td style="border:1px solid #cdcdcd;">Semen Fructose Qualitative</td>
                <td style="border:1px solid #cdcdcd;"><?php echo isset($select_result['semen_fructose_qualitative_1'])?$select_result['semen_fructose_qualitative_1']:""; ?></td>
                <td style="border:1px solid #cdcdcd;"></td>
                <td style="border:1px solid #cdcdcd;">Positive</td>
            </tr>
            <tr>
                <td colspan="4" style="border:1px solid #cdcdcd; font-weight:bold; background:#f2f2f2;">Special Test</td>
            </tr>
            <tr>
                <td style="border:1px solid #cdcdcd;">Sperm Vitality</td>
                <td style="border:1px solid #cdcdcd;"><?php echo isset($select_result['sperm_vitality'])?$select_result['sperm_vitality']:""; ?></td>
                <td style="border:1px solid #cdcdcd;">%</td>
  ...
  <table style="width:100%; border:1px solid #cdcdcd; margin-top:10px;" border="1">
        <thead>
            <tr>
                <th style="padding:8px; font-size:12px; font-weight:normal; text-align:left;">Not for Medico legal purpose. Results to be correlated with clinical findings for a final diagnosis Parameters are according to latest WHO Laboratory Manual for Examination & Processing of Human Semen FIFTH EDITION</th>
            </tr>
            <tr><th style="padding:15px 8px; text-align:left;">EMBRYOLOGIST SIGNATURE: </th></tr>
        </thead>
  </table>
</div>

<script>
// 🚀 FIXED: Sandboxed pop-up windows context injector
function printtable() 
{
  var divToPrint = document.getElementById('master_print_wrapper');
  var newWin = window.open('','Print-Window');
  newWin.document.open();
  
  // Naye window me table borders aur plain styling inject karne ka template rules
  newWin.document.write(`
    <html>
    <head>
        <title>Andrology Report</title>
        <style>
            body { font-family: Arial, sans-serif; padding: 20px; color: #000; }
            table { border-collapse: collapse; width: 100%; margin-bottom: 10px; }
            td, th { border: 1px solid #000; padding: 6px; text-align: left; font-size: 13px; }
            .vb45rt td { background: #b3b9b7 !important; font-weight: bold; }
            tr[style*="background"] td { background: #b3b9b7 !important; }
        </style>
    </head>
    <body onload="window.print(); setTimeout(function(){ window.close(); }, 50);">
