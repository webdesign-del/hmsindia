...
<input type="hidden" value="<?php echo $updated_at; ?>" class="form" name="updated_at">
  ...
  <table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">FNAC TESTES AND TESA THIRD CYCLE</h3></td>
   </tr>
</table>
...
<div  class="printtable prtable"  id="printtable"  style="display:none">  				
			 ...
			 <td width="50%" colspan="2" style="border:1px solid #cdcdcd;"><center><h2 class="text-alogn-center">FNAC TESTES AND TESA THIRD CYCLE</h2></center></td>
