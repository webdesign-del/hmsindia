...
<form enctype='multipart/form-data'  class ="searchform" name="form" action="" method="POST">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">EMBRYO TRANSFER/ FROZEN EMBRYO TRANSFER THIRD CYCLE</h3></td>
   </tr>
</table>
...
<td colspan="2" style="border:1px solid #cdcdcd;">
					...
					<td colspan="2" style="border:1px solid #cdcdcd;"><center><h3>EMBRYO TRANSFER/ FROZEN EMBRYO TRANSFER THIRD CYCLE</h3></center></td>
