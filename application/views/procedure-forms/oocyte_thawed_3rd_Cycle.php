<?php
	...
	$query_oocyte_freezing = "SELECT * FROM `hms_oocyte_freezing` WHERE patient_id='$patient_id' and type='Third Cycle'";
...
<input type="hidden" value="<?php echo $updated_at; ?>" class="form" name="updated_at">
  ...
  <input type="hidden" value="Third Cycle" name="type"> 
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">OOCYTE THAWING THIRD CYCLE</h3></td>
   </tr>
</table>
