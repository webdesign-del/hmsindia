...
<input type="hidden" value="<?php echo $updated_at; ?>" class="form" name="updated_at">
  ...
  <input type="hidden" value="Third Cycle" name="type"> 
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">IUI STIMULATION THIRD CTCLE</h3></td>
   </tr>
</table>
...
<div  class="printtable prtable"  id="printtable"  style="display:none">  
   ...
   <tr>
   <td style="width:50%;padding:5px;" colspan="10"><img src="<?php echo base_url(); ?>/assets/images/India-IVF-Logo-Option-5.png" style="width:220px"></td>
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">IUI STIMULATION THIRD CYCLE</h3></td>
   </tr>
</table>
		 <table width="100%" class="vb45rt">
<tbody>
