...
<table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">TESE AND M-TESE SECOND CYCLE</h3></td>
   </tr>
</table>
...
<table style="border:1px solid;width:100%;" class="fg45yu">
   ...
   <td style="width:50%;border:1px solid #ccc;" colspan="10"><h3 style="margin-top:20px;">TESE AND M-TESE SECOND CYCLE</h3></td>
   </tr>
</table>
 <table width="100%" class="vb45rt">
<tbody>
