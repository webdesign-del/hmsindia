<?php
	...
	$query_oocyte_freezing = "SELECT * FROM `hms_oocyte_freezing` WHERE patient_id='$patient_id' and type='Second Cycle'";
    $result_oocyte_freezing = run_select_query($query_oocyte_freezing); 
...
<input type="hidden" value="<?php echo $updated_at; ?>" class="form" name="updated_at">
  ...
  <input type="hidden" value="Second Cycle" name="type"> 
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">OOCYTE THAWING SECOND CYCLE</h3></td>
   </tr>
</table>
    				...
    				<div class='table-responsive2'>
    					<table class="table table-bordered table-hover mt-2 table-sm red-field">
					        ...
					        <thead>
							 ...
							 <thead>
					        	<tr>
					        		<th colspan="17" style="background: #FFC000">Total No Of Oocyte Frozen: <input type="text" value="<?php echo isset($result_oocyte_freezing['total_oocyte_frozen'])?$result_oocyte_freezing['total_oocyte_frozen']:""; ?>" readonly=""  ></th>
					        	</tr>
					        </thead>
					        <thead>
					        	<tr>
