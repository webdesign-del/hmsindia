...
<table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">MOCK EMBRYO TRANSFER</h3></td>
   </tr>
</table>
...
<table style="width:100%; border:1px solid #cdcdcd;" id="printtable" border="1">
 ...
 <thead>
			<tr>
				...
				<th width="50%" colspan="3"><center><h2>MOCK EMBRYO TRANSFER <h2></center></th>
