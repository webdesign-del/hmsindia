...
$all_method =& get_instance();
    ...
    if(isset($_POST['submit'])){
        ...
        $sql = "SELECT * FROM `fnac_testes_discharge_summary` WHERE patient_id='$patient_id'";
...
<tr>
   ...
   <td style="width:50%;padding:5px;" colspan="2"><h3 style="margin-top:20px;">Fnac Testes</h3></td>
</tr>
</table>
<form action="" enctype='multipart/form-data' method="post"> 
<table width="100%" class="vb45rt">
