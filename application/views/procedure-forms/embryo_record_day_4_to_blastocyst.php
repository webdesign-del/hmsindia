...
<input type="hidden" value="<?php echo $updated_at; ?>" class="form" name="updated_at">
  ...
  <input type="hidden" value="First Cycle" name="cycle_type"> 
    			<div class="container red-field form mt-5 mb-5">
	<table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
	   <tr>
	   <td style="width:50%;padding:5px;" colspan="10"><img src="<?php echo base_url(); ?>/assets/images/India-IVF-Logo-Option-5.png" style="width:220px"></td>
	   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">EMBRYO RECODR DAY 4 TO BLASTOCYST</h3></td>
	   </tr>
	</table>
	<table style="border:1px solid;width:100%;padding:5px;" class="fg45yu">
    					...
    					<table class="table table-bordered table-hover mt-2 table-sm red-field">
					        ...
					        <thead>
					        	<tr>
							        ...
							        <input type="checkbox" name="type" value="DEGENERATE" <?php if(isset($select_result['type']) && $select_result['type'] == "DEGENERATE"){echo 'checked="checked"'; }?>> DEGENERATE<br>
									<input type="checkbox" name="type" value="DISCARD" <?php if(isset($select_result['type']) && $select_result['type'] == "DISCARD"){echo 'checked="checked"'; }?>> DISCARD<br>
                                    </td>
                                    <td style="background: #FEF2CB" colspan="2"></td>
					        ...
					        <thead>
					        	<tr>
							        ...
							        <td style="background: #C5E0B3" colspan="5">
									<input type="checkbox" name="type_1" value="TRANSFER" <?php if(isset($select_result['type_1']) && $select_result['type_1'] == "TRANSFER"){echo 'checked="checked"'; }?>> TRANSFER<br>
							        <input type="checkbox" name="type_1" value="FREEZING" <?php if(isset($select_result['type_1']) && $select_result['type_1'] == "FREEZING"){echo 'checked="checked"'; }?>> FREEZING<br>
							        <input type="checkbox" name="type_1" value="DEGENERATE" <?php if(isset($select_result['type_1']) && $select_result['type_1'] == "DEGENERATE"){echo 'checked="checked"'; }?>> DEGENERATE<br>
									<input type="checkbox" name="type_1" value="DISCARD" <?php if(isset($select_result['type_1']) && $select_result['type_1'] == "DISCARD"){echo 'checked="checked"'; }?>> DISCARD<br>
                                    </td>
                                    <td style="background: #FEF2CB" colspan="2"></td>
					        ...
					        <thead>
					        	<tr>
							        ...
							        <td style="background: #C5E0B3" colspan="5">
									<input type="checkbox" name="type_2" value="TRANSFER" <?php if(isset($select_result['type_2']) && $select_result['type_2'] == "TRANSFER"){echo 'checked="checked"'; }?>> TRANSFER<br>
							        <input type="checkbox" name="type_2" value="FREEZING" <?php if(isset($select_result['type_2']) && $select_result['type_2'] == "FREEZING"){echo 'checked="checked"'; }?>> FREEZING<br>
							        <input type="checkbox" name="type_2" value="DEGENERATE" <?php if(isset($select_result['type_2']) && $select_result['type_2'] == "DEGENERATE"){echo 'checked="checked"'; }?>> DEGENERATE<br>
									<input type="checkbox" name="type_2" value="DISCARD" <?php if(isset($select_result['type_2']) && $select_result['type_2'] == "DISCARD"){echo 'checked="checked"'; }?>> DISCARD<br>
                                    </td>
                                    <td style="background: #FEF2CB" colspan="2"></td>
					        ...
					        <thead>
					        	<tr>
							        ...
							        <td style="background: #C5E0B3" colspan="5">
									<input type="checkbox" name="type_3" value="TRANSFER" <?php if(isset($select_result['type_3']) && $select_result['type_3'] == "TRANSFER"){echo 'checked="checked"'; }?>> TRANSFER<br>
							        <input type="checkbox" name="type_3" value="FREEZING" <?php if(isset($select_result['type_3']) && $select_result['type_3'] == "FREEZING"){echo 'checked="checked"'; }?>> FREEZING<br>
							        <input type="checkbox" name="type_3" value="DEGENERATE" <?php if(isset($select_result['type_3']) && $select_result['type_3'] == "DEGENERATE"){echo 'checked="checked"'; }?>> DEGENERATE<br>
									<input type="checkbox" name="type_3" value="DISCARD" <?php if(isset($select_result['type_3']) && $select_result['type_3'] == "DISCARD"){echo 'checked="checked"'; }?>> DISCARD<br>
                                    </td>
                                    <td style="background: #FEF2CB" colspan="2"></td>
					        ...
					        <thead>
					        	<tr>
									...
									<td style="background: #C5E0B3" colspan="5">
									<input type="checkbox" name="type_4" value="TRANSFER" <?php if(isset($select_result['type_4']) && $select_result['type_4'] == "TRANSFER"){echo 'checked="checked"'; }?>> TRANSFER<br>
							        <input type="checkbox" name="type_4" value="FREEZING" <?php if(isset($select_result['type_4']) && $select_result['type_4'] == "FREEZING"){echo 'checked="checked"'; }?>> FREEZING<br>
							        <input type="checkbox" name="type_4" value="DEGENERATE" <?php if(isset($select_result['type_4']) && $select_result['type_4'] == "DEGENERATE"){echo 'checked="checked"'; }?>> DEGENERATE<br>
									<input type="checkbox" name="type_4" value="DISCARD" <?php if(isset($select_result['type_4']) && $select_result['type_4'] == "DISCARD"){echo 'checked="checked"'; }?>> DISCARD<br>
                                    </td>
                                    <td style="background: #FEF2CB" colspan="2"></td>
					        ...
					        <thead>
					        	<tr>
							        ...
							        <td style="background: #C5E0B3" colspan="5">
									<input type="checkbox" name="type_5" value="TRANSFER" <?php if(isset($select_result['type_5']) && $select_result['type_5'] == "TRANSFER"){echo 'checked="checked"'; }?>> TRANSFER<br>
							        <input type="checkbox" name="type_5" value="FREEZING" <?php if(isset($select_result['type_5']) && $select_result['type_5'] == "FREEZING"){echo 'checked="checked"'; }?>> FREEZING<br>
							        <input type="checkbox" name="type_5" value="DEGENERATE" <?php if(isset($select_result['type_5']) && $select_result['type_5'] == "DEGENERATE"){echo 'checked="checked"'; }?>> DEGENERATE<br>
									<input type="checkbox" name="type_5" value="DISCARD" <?php if(isset($select_result['type_5']) && $select_result['type_5'] == "DISCARD"){echo 'checked="checked"'; }?>> DISCARD<br>
                                    </td>
                                    <td style="background: #FEF2CB" colspan="2"></td>
					        ...
					        <thead>
					        	<tr>
							        ...
							        <td style="background: #C5E0B3" colspan="5">
									<input type="checkbox" name="type_6" value="TRANSFER" <?php if(isset($select_result['type_6']) && $select_result['type_6'] == "TRANSFER"){echo 'checked="checked"'; }?>> TRANSFER<br>
							        <input type="checkbox" name="type_6" value="FREEZING" <?php if(isset($select_result['type_6']) && $select_result['type_6'] == "FREEZING"){echo 'checked="checked"'; }?>> FREEZING<br>
							        <input type="checkbox" name="type_6" value="DEGENERATE" <?php if(isset($select_result['type_6']) && $select_result['type_6'] == "DEGENERATE"){echo 'checked="checked"'; }?>> DEGENERATE<br>
									<input type="checkbox" name="type_6" value="DISCARD" <?php if(isset($select_result['type_6']) && $select_result['type_6'] == "DISCARD"){echo 'checked="checked"'; }?>> DISCARD<br>
                                    </td>
                                    <td style="background: #FEF2CB" colspan="2"></td>
					        ...
					        <thead>
					        	<tr>
							        ...
							        <td style="background: #C5E0B3" colspan="5">
									<input type="checkbox" name="type_7" value="TRANSFER" <?php if(isset($select_result['type_7']) && $select_result['type_7'] == "TRANSFER"){echo 'checked="checked"'; }?>> TRANSFER<br>
							        <input type="checkbox" name="type_7" value="FREEZING" <?php if(isset($select_result['type_7']) && $select_result['type_7'] == "FREEZING"){echo 'checked="checked"'; }?>> FREEZING<br>
							        <input type="checkbox" name="type_7" value="DEGENERATE" <?php if(isset($select_result['type_7']) && $select_result['type_7'] == "DEGENERATE"){echo 'checked="checked"'; }?>> DEGENERATE<br>
									<input type="checkbox" name="type_7" value="DISCARD" <?php if(isset($select_result['type_7']) && $select_result['type_7'] == "DISCARD"){echo 'checked="checked"'; }?>> DISCARD<br>
                                    </td>
                                    <td style="background: #FEF2CB" colspan="2"></td>
					        ...
					        <thead>
					        	<tr>
									...
									<td style="background: #C5E0B3" colspan="5">
									<input type="checkbox" name="type_8" value="TRANSFER" <?php if(isset($select_result['type_8']) && $select_result['type_8'] == "TRANSFER"){echo 'checked="checked"'; }?>> TRANSFER<br>
							        <input type="checkbox" name="type_8" value="FREEZING" <?php if(isset($select_result['type_8']) && $select_result['type_8'] == "FREEZING"){echo 'checked="checked"'; }?>> FREEZING<br>
							        <input type="checkbox" name="type_8" value="DEGENERATE" <?php if(isset($select_result['type_8']) && $select_result['type_8'] == "DEGENERATE"){echo 'checked="checked"'; }?>> DEGENERATE<br>
									<input type="checkbox" name="type_8" value="DISCARD" <?php if(isset($select_result['type_8']) && $select_result['type_8'] == "DISCARD"){echo 'checked="checked"'; }?>> DISCARD<br>
                                    </td>
                                    <td style="background: #FEF2CB" colspan="2"></td>
					        ...
					        <thead>
					        	<tr>
							        ...
							        <td style="background: #C5E0B3" colspan="5">
									<input type="checkbox" name="type_9" value="TRANSFER" <?php if(isset($select_result['type_9']) && $select_result['type_9'] == "TRANSFER"){echo 'checked="checked"'; }?>> TRANSFER<br>
							        <input type="checkbox" name="type_9" value="FREEZING" <?php if(isset($select_result['type_9']) && $select_result['type_9'] == "FREEZING"){echo 'checked="checked"'; }?>> FREEZING<br>
							        <input type="checkbox" name="type_9" value="DEGENERATE" <?php if(isset($select_result['type_9']) && $select_result['type_9'] == "DEGENERATE"){echo 'checked="checked"'; }?>> DEGENERATE<br>
									<input type="checkbox" name="type_9" value="DISCARD" <?php if(isset($select_result['type_9']) && $select_result['type_9'] == "DISCARD"){echo 'checked="checked"'; }?>> DISCARD<br>
                                    </td>
                                    <td style="background: #FEF2CB" colspan="2"></td>
