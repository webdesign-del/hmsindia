<?php
    ...
    if(isset($_POST['submit'])){
        unset($_POST['submit']);
        //var_dump($_POST);die;
		$select_query = "SELECT * FROM `hms_opu` WHERE patient_id='$patient_id' and receipt_number='$receipt_number' and type='Second Cycle'";
...
<input type="hidden" value="Second Cycle" class="form" name="type">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">OPU SECOND CYCLE</h3></td>
   </tr>
</table>
...
<table style="border:1px solid;width:100%;" class="fg45yu">
   ...
   <td style="width:50%;border:1px solid #ccc;" colspan="10"><h3 style="margin-top:20px;">OPU SECOND CYCLE</h3></td>
   </tr>
</table>
 <table width="100%" class="vb45rt">
<tbody>
