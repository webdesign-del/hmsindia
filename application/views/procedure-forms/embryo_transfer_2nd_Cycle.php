...
<form enctype='multipart/form-data'  class ="searchform" name="form" action="" method="POST">
   ...
   <td style="width:50%;padding:5px;" colspan="10"><h3 style="margin-top:20px;">EMBRYO TRANSFER/ FROZEN EMBRYO TRANSFER SECOND CYCLE</h3></td>
   </tr>
</table>
			...
			<table class="table-bordered" width="100%">
				...
				<tr>
					...
					<td>
						...
						difficulty to a depth of cm. <input type="number" min="0" value="<?php echo isset($select_result['depth'])?$select_result['depth']:""; ?>" name="depth" >  Visualization with ultrasound <input type="radio">was  <input type="radio"> was not successful.<br>

						The patient requested that an attempt be made to transfer the <input type="number" min="0" value="<?php echo isset($select_result['transfer_embryos'])?$select_result['transfer_embryos']:""; ?>" name="transfer_embryos" > embryos. It was necessary to thaw the <input type="number" min="0" value="<?php echo isset($select_result['thaw_embryos'])?$select_result['thaw_embryos']:""; ?>" name="thaw_embryos" > of embryos. <input type="number" min="0" value="<?php echo isset($select_result['embryos_deposited'])?$select_result['embryos_deposited']:""; ?>" name="embryos_deposited" > embryos were deposited into the uterine cavity.<br>

						The catheter was removed and rechecked by embryologist  for embryos  .There was no retention/ retention seen . In case of retention Again embryo was transferred and rechecked The speculum was removed and the patient was transferred to recovery for a period of rest prior to discharge.<br>
...
<td colspan="2" style="border:1px solid #cdcdcd;">
					...
					<td colspan="2" style="border:1px solid #cdcdcd;"><center><h3>EMBRYO TRANSFER/ FROZEN EMBRYO TRANSFER SECOND CYCLE</h3></center></td>
