...
<div class="row">
    <div class="col-md-12">
        <h1 class="page-header">
            <i class="fa fa-building"></i> Center Stocks Stationary HouseKeeping
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form method="get" action="<?php echo base_url('stocks_new/stationary_housekeeping_center'); ?>" class="form-inline">
                    ...
                    <a href="<?php echo base_url('stocks_new/stationary_housekeeping_center'); ?>" class="btn btn-default">
