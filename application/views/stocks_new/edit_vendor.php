...
<div class="content-wrapper">
    <section class="content-header">
        <h1>
            Edit Vendor
            <small>Update vendor information</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php echo form_open('stocks_new/edit_vendor/' . $vendor->ID, array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data')); ?>
                    <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="company_name" name="company_name" 
                                               value="<?php echo set_value('company_name', isset($vendor->company_name) ? $vendor->company_name : ''); ?>" required>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="companies_type" id="companies_type" class="form-control" required>
                                            ...
                                            <option value="Private limited company" <?php echo set_select('companies_type', 'Private limited company', (isset($vendor->companies_type) && $vendor->companies_type == 'Private limited company')); ?>>Private limited company</option>
                                            <option value="Partnership" <?php echo set_select('companies_type', 'Partnership', (isset($vendor->companies_type) && $vendor->companies_type == 'Partnership')); ?>>Partnership</option>
                                            <option value="Limited Liability Company" <?php echo set_select('companies_type', 'Limited Liability Company', (isset($vendor->companies_type) && $vendor->companies_type == 'Limited Liability Company')); ?>>Limited Liability Company</option>
                                            <option value="Holding company" <?php echo set_select('companies_type', 'Holding company', (isset($vendor->companies_type) && $vendor->companies_type == 'Holding company')); ?>>Holding company</option>
                                        </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea class="form-control" id="company_address" name="company_address" rows="3" required><?php echo set_value('company_address', isset($vendor->company_address) ? $vendor->company_address : ''); ?></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="phone_number" name="phone_number" 
                                               value="<?php echo set_value('phone_number', isset($vendor->phone_number) ? $vendor->phone_number : ''); ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" class="form-control" id="email" name="email" 
                                               value="<?php echo set_value('email', isset($vendor->email) ? $vendor->email : ''); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="contact_person_name" name="contact_person_name" 
                                               value="<?php echo set_value('contact_person_name', isset($vendor->contact_person_name) ? $vendor->contact_person_name : ''); ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="contact_person_designation" name="contact_person_designation" 
                                               value="<?php echo set_value('contact_person_designation', isset($vendor->contact_person_designation) ? $vendor->contact_person_designation : ''); ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="bank_name" name="bank_name" 
                                               value="<?php echo set_value('bank_name', isset($vendor->bank_name) ? $vendor->bank_name : ''); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="branch_name" name="branch_name" 
                                               value="<?php echo set_value('branch_name', isset($vendor->branch_name) ? $vendor->branch_name : ''); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="beneficiary_name" name="beneficiary_name" 
                                               value="<?php echo set_value('beneficiary_name', isset($vendor->beneficiary_name) ? $vendor->beneficiary_name : ''); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="account_no" name="account_no" 
                                               value="<?php echo set_value('account_no', isset($vendor->account_no) ? $vendor->account_no : ''); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="ifsc_code" name="ifsc_code" 
                                               value="<?php echo set_value('ifsc_code', isset($vendor->ifsc_code) ? $vendor->ifsc_code : ''); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="account_type" id="account_type" class="form-control">
                                            ...
                                            <option value="Savings Account" <?php echo set_select('account_type', 'Savings Account', (isset($vendor->account_type) && $vendor->account_type == 'Savings Account')); ?>>Savings Account</option>
                                            <option value="Current Account" <?php echo set_select('account_type', 'Current Account', (isset($vendor->account_type) && $vendor->account_type == 'Current Account')); ?>>Current Account</option>
                                            <option value="Salary Account" <?php echo set_select('account_type', 'Salary Account', (isset($vendor->account_type) && $vendor->account_type == 'Salary Account')); ?>>Salary Account</option>
                                        </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="gst_number" name="gst_number" 
                                               value="<?php echo set_value('gst_number', $vendor->gst_number); ?>" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php if(isset($vendor->gst_file) && !empty($vendor->gst_file)): ?>
                                            <div class="text-info">
                                                <i class="fa fa-file"></i> Current: <?php echo $vendor->gst_file; ?>
                                            </div>
                                        <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="drug_license_number" name="drug_license_number" 
                                               value="<?php echo set_value('drug_license_number', isset($vendor->drug_license_number) ? $vendor->drug_license_number : ''); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php if(isset($vendor->drug_license_file) && !empty($vendor->drug_license_file)): ?>
                                            <div class="text-info">
                                                <i class="fa fa-file"></i> Current: <?php echo $vendor->drug_license_file; ?>
                                            </div>
                                        <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="pan_number" name="pan_number" 
                                               value="<?php echo set_value('pan_number', isset($vendor->pan_number) ? $vendor->pan_number : ''); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php if(isset($vendor->pan_file) && !empty($vendor->pan_file)): ?>
                                            <div class="text-info">
                                                <i class="fa fa-file"></i> Current: <?php echo $vendor->pan_file; ?>
                                            </div>
                                        <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="fssai_number" name="fssai_number" 
                                               value="<?php echo set_value('fssai_number', isset($vendor->fssai_number) ? $vendor->fssai_number : ''); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php if(isset($vendor->fssai_file) && !empty($vendor->fssai_file)): ?>
                                            <div class="text-info">
                                                <i class="fa fa-file"></i> Current: <?php echo $vendor->fssai_file; ?>
                                            </div>
                                        <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="msme_number" name="msme_number" 
                                               value="<?php echo set_value('msme_number', isset($vendor->msme_number) ? $vendor->msme_number : ''); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php if(isset($vendor->msme_file) && !empty($vendor->msme_file)): ?>
                                            <div class="text-info">
                                                <i class="fa fa-file"></i> Current: <?php echo $vendor->msme_file; ?>
                                            </div>
                                        <?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php if(isset($vendor->cancel_check) && !empty($vendor->cancel_check)): ?>
                                            <div class="text-info">
                                                <i class="fa fa-file"></i> Current: <?php echo $vendor->cancel_check; ?>
                                            </div>
                                        <?php endif; ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <?php if(isset($vendor->mou_file) && !empty($vendor->mou_file)): ?>
                                            <div class="text-info">
                                                <i class="fa fa-file"></i> Current: <?php echo $vendor->mou_file; ?>
                                            </div>
                                        <?php endif; ?>
                        ...
                        <div class="row">
                                        ...
                                        <div>
                                            <label class="radio-inline">
                                                <input type="radio" name="status" value="1" 
                                                       <?php echo set_radio('status', '1', ($vendor->status == '1' || $vendor->status == 'active')); ?>> Active
                                            </label>
                                            <label class="radio-inline">
                                                <input type="radio" name="status" value="0" 
                                                       <?php echo set_radio('status', '0', ($vendor->status == '0' || $vendor->status == 'inactive')); ?>> Inactive
                                            </label>
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Vendor Number</label>
                                    <div class="col-sm-9">
                                        <p class="form-control-static"><?php echo isset($vendor->vendor_number) ? $vendor->vendor_number : 'N/A'; ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
