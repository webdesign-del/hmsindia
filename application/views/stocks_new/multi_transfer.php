        ...
        <div class="row">
            <div class="col-md-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active">Multi-Item Transfer</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form action="<?php echo base_url('stocks_new/multi_transfer'); ?>" method="post" class="form-horizontal" id="multiTransferForm">
                            <input type="hidden" name="action" value="multi_transfer">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h4><i class="fa fa-list text-warning"></i> Transfer Summary</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="remarks" class="form-control" rows="3" placeholder="Enter any remarks about this transfer"><?php echo set_value('remarks'); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function updateHiddenInputs() {
    ...
    $.each(transferItems, function(index, item) {
        $('#multiTransferForm').append('<input type="hidden" name="transfer_items[' + index + '][batch_id]" value="' + item.batch_id + '">');
        $('#multiTransferForm').append('<input type="hidden" name="transfer_items[' + index + '][quantity]" value="' + item.quantity + '">');
        $('#multiTransferForm').append('<input type="hidden" name="transfer_items[' + index + '][remarks]" value="' + item.remarks + '">');
    });
}
