                                                        ...
                                                        <select name="return_items[0][batch_id]" class="form-control batch_select" required>
                                                            ...
                                                            <?php foreach($available_batches as $batch): ?>
                                                                <option value="<?php echo $batch->id; ?>" 
                                                                        ...
                                                                        data-sold-qty="<?php echo $batch->quantity_sold; ?>">
...
$(document).ready(function() {
    ...
    $('#add_return_item').click(function() {
        var newRow = '<tr>' +
            ...
            '<option value="">Select Medicine</option>' +
            '<?php foreach($available_batches as $batch): ?>' +
            '<option value="<?php echo $batch->id; ?>" data-medicine="<?php echo $batch->medicine_name; ?>" data-price="<?php echo $batch->selling_price; ?>" data-sold-qty="<?php echo $batch->quantity_sold; ?>"><?php echo $batch->medicine_name . ' - ' . $batch->batch_number; ?></option>' +
            '<?php endforeach; ?>' +
            '</select></td>' +
            '<td><span class="batch_number">-</span></td>' +
            '<td><span class="sold_quantity">-</span></td>' +
    ...
    $(document).on('change', '.batch_select', function() {
        ...
        if (selectedOption.val()) {
            ...
            row.find('.unit_price').text('₹' + selectedOption.data('price'));
