                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <?php if (isset($selected_center_id) && !empty($selected_center_id)): ?>
                                        <input type="hidden" name="center_id" id="hidden_center_id" value="<?php echo $selected_center_id; ?>">
                                        
                                        <!-- Note: 'disabled' removed so form POSTs properly, using pointer-events:none for visual disable -->
                                        <select class="form-control" id="center_id_select" style="background-color: #e9ecef; cursor: not-allowed; pointer-events: none;">
