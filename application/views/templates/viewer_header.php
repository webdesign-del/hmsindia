...
<nav class="navbar navbar-default top-navbar" role="navigation">
  ...
  <ul class="nav navbar-top-links navbar-right">
    ...
    <li><a class="dropdown-button waves-effect waves-dark" href="#!" data-activates="dropdown1"><i class="fa fa-user fa-fw"></i> <b><?php echo $_SESSION['logged_viewer']['name']?></b> <i class="material-icons right">arrow_drop_down</i></a></li>
  </ul>
</nav>
<!-- Dropdown Structure -->
<ul id="dropdown1" class="dropdown-content">
  ...
  <li><a href="<?php echo base_url(); ?>logout?r=<?php echo base64_encode('logged_viewer'); ?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a> </li>
</ul>
...
<nav class="navbar-default navbar-side" style="overflow:scroll;height:100%" role="navigation">
  <div class="sidebar-collapse">
    <ul class="nav" id="main-menu">
	  ...
	  <?php
$allowed_users = ["tanushkayadav2602@gmail.com", "deep@tomorrowcapital.in"];

if (isset($_SESSION['logged_viewer']['username']) && in_array($_SESSION['logged_viewer']['username'], $allowed_users)) {
?>
	   
	    <li> <a href="<?php echo base_url(); ?>doctor_appointments"><i class="fa fa-sitemap"></i>Appointment</a> </li>
		<li> <a href="<?php echo base_url(); ?>doctors/doctor_patient"><i class="fa fa-sitemap"></i>OPD Register</a> </li>
      ...
      <li> <a href="<?php echo base_url(); ?>patients/embryo_freezing">Embryo Freezing</a> </li>
		  ...
		  <li> <a href="<?php echo base_url(); ?>patients/embryo_intra_uterine">Intra Uterine</a> </li>
		  <li> <a href="<?php echo base_url(); ?>patients/embryo_sperm_dna">Sperm Dna Fragmentation</a> </li>
      ...
      <li> <a href="<?php echo base_url(); ?>accounts/procedure_advice" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>Financial Clearance</a></li>
      <li> <a href="<?php echo base_url(); ?>accounts/reports" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>Revenue Dashboard</a></li>
      <li> <a href="<?php echo base_url(); ?>billings/forma_invoice_list" class="waves-effect waves-dark"><i class="fa fa-sitemap"></i>Forma Invoice</a></li>
      ...
      <li> <a href="<?php echo base_url(); ?>accounts/partial_procedure">Partial Procedure</a> </li>
