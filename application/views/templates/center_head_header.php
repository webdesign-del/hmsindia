...
<nav class="navbar navbar-default top-navbar" role="navigation">
  ...
  <ul class="nav navbar-top-links navbar-right">
    ...
    <a class="dropdown-button waves-effect waves-dark" href="#!" data-activates="dropdown4">
        ...
        $center_id_session = $_SESSION['logged_center_head']['center'];
    ...
    <li><a class="dropdown-button waves-effect waves-dark" href="#!" data-activates="dropdown1"><i class="fa fa-user fa-fw"></i> <b><?php echo $_SESSION['logged_center_head']['name']?></b> <i class="material-icons right">arrow_drop_down</i></a></li>
...
<ul id="dropdown1" class="dropdown-content">
  ...
  <li><a href="<?php echo base_url(); ?>logout?r=<?php echo base64_encode('logged_center_head'); ?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a> </li>
 <li><a href="<?php echo base_url(); ?>employees/edit_center?employee_number=<?php echo $_SESSION['logged_center_head']['employee_number']?>"><i class="fa fa-user fa-fw"></i>Change Center </a></li>
