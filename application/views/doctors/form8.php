...
<h3 style="text-align:center;margin: 10px 0px;">INFORMED CONSENT FOR INTRAUTERINE INSEMINATION /ART WITH DONOR SEMEN</h3>
<form action="" enctype='multipart/form-data' method="post">  
<table width="100%" class="">
<tbody>
<tr>
<td colspan="3">
<p style="padding: 9px 10px;">I/We,<span id="username" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name" value="" style="border:0px; width:350px"></span> being of legal age,
...
<tr><td colspan="3" style="padding: 10px 10px;">I/We understand that even though the insemination may be repeated as often as recommended by the doctor, there is no guarantee or assurance that pregnancy or a live birth will result.</td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">I/We have also been told that the outcome of pregnancy may not be the same as those of the general pregnant population, for example in respect of abortion, multiple pregnancies, anomalies or complications of pregnancy or delivery.</td></tr>
<tr><td colspan="3" style="padding: 9px 10px;">I/We declare that we shall not attempt to find out the identity of the donor.</td></tr>
<tr><td colspan="3" style="padding: 9px 10px;">I, the husband, also declare that should my wife bear any child or children as a result of such insemination(s),such child or children shall be as my own and shall be my legal heir(s). (if applicable) </td></tr>
...
<tr><td colspan="3" style="padding: 9px 10px;">Signature of intending couple/ intending woman <span id="username7" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name7" value="" style="border-bottom: 1px dotted;border-top:0px;border-left:0px;border-right:0px;width: 200px;" /></span></td><br></tr>

<tr><td colspan="3" style="padding: 9px 10px;">Endorsement by the ART clinic</td></tr>

<tr>
<td colspan="3" style="padding: 9px 10px;">
<p>I/we have personally explained to <span id="username8" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name8" value="" style="border:0px; width:300px"></span> and <span id="username9" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name9" value="" style="border:0px; width:300px"></span> the details and implications of
...
<tr><td colspan="3" style="padding: 9px 10px;">Name, Address and Signature of the Witness from the clinic <span id="username10" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name10" value="" style="border-bottom: 1px dotted;border-top:0px;border-left:0px;border-right:0px;width: 200px;" /></span></td></tr>
...
<tr><td colspan="3"></td></tr>
<tr><td colspan="3" style="color:#000000; padding: 5px 10px;">Name and Signature of the Doctor <span id="username13" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name13" value="" style="border-bottom: 1px dotted;border-top:0px;border-left:0px;border-right:0px;width: 200px;" /></span></td></tr>
<tr><td colspan="3" style="color:#000000; padding: 5px 10px;">Name and Address of the ART clinic <span id="username14" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name14" value="" style="border-bottom: 1px dotted;border-top:0px;border-left:0px;border-right:0px;width: 200px;" /></span></td></tr>
