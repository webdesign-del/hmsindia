...
<div class="col-lg-12"> <?php 
                ...
                <?php endif; ?></div>
<h3 style="text-align:center;margin: 10px 0px;">Consent for Blastocyst Culture </h3>
<form action="" enctype='multipart/form-data' method="post">  
<table width="100%" class="">
<tbody>
<tr><td colspan="3" style="padding: 10px 10px;">We hereby request and give consent to the procedure of blastocyst culture to be performed on the gametes.</td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">Embryos being grown up to five days following egg retrieval which is referred to as a blastocyst culture. Blastocyst culture involves placing embryos into culture in the laboratory for an additional two days to observe their continued development prior to transfer or freezing.</td></tr>
<tr><td colspan="3" style="padding: 10px 10px;"> The literature indicates that this technique may be useful in selecting the most viable embryos, enabling the transfer of fewer embryos with a corresponding reduction in the risk of multiple pregnancies, and maintaining the same pregnancy rate as a day 3 transfer. In some cases, one or more of the embryos may stop growing prior to reaching the blastocyst stage. This may result in fewer embryos for transfer or if all go to good embryos then extra embryos for freezing , and, in some cases, no embryo transfer at all. We (I) acknowledge that we (I) have discussed the possibility of the need for these procedures with our (my) physician and understand and agree that it will be utilized based on the best medical judgment of the India IVF clinic staff at the time of our (my) procedure. </td></tr>
<tr><td colspan="3" style="padding: 9px 10px;">We (I) give consent for blastocyst culture  to be performed . </td></tr>
<tr><td colspan="3" style="padding: 9px 10px;">Each of the above points has been explained to us by <span id="username" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name" value="" style="border: 0px; width: 250px;" /></span></td></tr>
...
<tr><td colspan="3" style="padding: 9px 10px;"><h3 style="margin: 10px 0px;">Endorsement by the ART clinic  </h3></td></tr>

<tr><td colspan="3" style="padding: 9px 10px;">I/we have personally explained to  <span id="username2" style="border-bottom: 1px dotted;"><input type="text" name="name2" id="name2" value="" style="border:0px; width:300px"></span> and  <span id="username3" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name3" value="" style="border: 0px; width: 250px;" /></span>, the details and implications of his/her/their signing this consent/approval form, and made sure to the extent humanly possible that he/she/they understand these details and implications. </td></tr>
