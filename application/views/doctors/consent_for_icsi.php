...
<div class="col-lg-12"> <?php 
                ...
                <?php endif; ?></div>
<h3 style="text-align:center;margin: 10px 0px;">Consent for ICSI (INTRACYTOPLASMIC SPERM INJECTION)</h3>
<form action="" enctype='multipart/form-data' method="post">  
<table width="100%" class="">
<tbody>
<tr><td colspan="3" style="padding: 10px 10px;">We hereby request and give consent to the procedure of  ICSI, to be performed on the gametes.</td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">We understand that </td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">Mixing the eggs (self/donor) and sperm (self/donor) together (insemination) to allow fertilization to occur. Certain circumstances may exist to predict that your eggs/sperm are unlikely to fertilize using this conventional technique. In these cases, a procedure called intracytoplasmic sperm injection (ICSI) will be used. ICSI differs from insemination in that instead of combining sperm and eggs together and allowing fertilization to occur spontaneously, sperms are individually injected into each egg using a needle.This technique greatly increases the chances that the eggs will fertilize and can help overcome any fertilization problem. We (I) understand that there are associated risks with ICSI and any of the following may occur which would prevent ICSI from being performed, or prevent the establishment of pregnancy: </td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">a. Mature oocytes (eggs) are required to perform ICSI; therefore, if no eggs are retrieved or none of the eggs are mature, ICSI will not be possible. </td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">b. Viable sperm may not be available for use in ICSI.</td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">c. Fertilization may not occur even after ICSI is performed. </td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">d. Rarely, injury to the oocyte(s) may occur during ICSI. </td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">e. Cleavage or cell division of fertilized egg(s) may not occur. </td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">f. The fertilized eggs may not develop normally. If pregnancy is successfully established, miscarriage, ectopic pregnancy, heterotopic pregnancy ,stillbirth, multiple births, and/or congenital abnormalities (birth defects) may occur that are unrelated to this procedure, at the same rate as if unassisted fertilization (conventional insemination for IVF) had occurred. In situations where the male factor is the result of a genetic defect, the ICSI procedure may permit fertilization to occur normally, but the genetic defect may be passed on to resulting offspring. There is insufficient information at this time as to whether the occurrence of these are increased or decreased by this procedure.</td></tr>

<tr><td colspan="3" style="padding: 10px 10px;">Each of the above points has been explained to us by <span id="username3" style="border-bottom: 1px dotted;"><input type="text" name="name2" id="name3" value="" style="border:0px; width:300px"></span></td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">The procedure(s) carried out does (do) not ensure a positive result, nor do they guarantee a mentally and physically normal baby. </td></tr>

<tr><td colspan="3" style="padding: 10px 10px;"><br></td></tr>
