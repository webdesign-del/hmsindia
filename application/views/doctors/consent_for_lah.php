...
<div class="col-lg-12"> <?php 
                ...
                <?php endif; ?></div>
<h3 style="text-align:center;margin: 10px 0px;">Consent for LAH (LASER ASSISTED HATCHING)</h3>
<form action="" enctype='multipart/form-data' method="post">  
<table width="100%" class="">
<tbody>
<tr><td colspan="3" style="padding: 10px 10px;">We hereby request and give consent to the procedure of Laser Assisted Hatching to be performed on the gametes.</td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">We understand that </td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">In certain situations the zona pellucida (the eggshell surrounding the embryo) is abnormally thick and/or hardened and embryos are not able to break out of the zona pellucida spontaneously. This condition, which may compromise the ability of the embryo to implant in the uterine wall, is improved with a procedure called assisted hatching. Assisted hatching involves making a small hole in the zona pellucida using micromanipulation techniques. </td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">This procedure  may make it easier for the embryo(s) to emerge from their zona pellucida giving them an improved chance for implantation. Criteria for performing assisted hatching include appearance of the embryo and the zona pellucida. A thickened zona pellucida is commonly seen with advanced maternal age. Literature suggests that the procedure may benefit older women, those with elevated day 3 FSH levels, and in patients with prior unsuccessful IVF treatments. There are risks associated with this technique. </td></tr>
<tr><td colspan="3" style="padding: 10px 10px;">a. The embryo may be damaged during the process reducing the number of embryos available for transfer.</td></tr>
<tr><td colspan="3" style="padding: 10px 10px;"> b. Despite the use of assisted hatching, implantation may not occur. </td></tr>

<tr><td colspan="3" style="padding: 10px 10px;">Each of the above points has been explained to us by  <span id="username3" style="border-bottom: 1px dotted;"><input type="text" name="name2" id="name3" value="" style="border:0px; width:300px"></span>The procedure(s) carried out does (do) not ensure a positive result, nor do they guarantee a mentally and physically normal baby.  </td></tr>
