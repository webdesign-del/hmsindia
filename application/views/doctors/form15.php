    ...
    <div class="card-content">
        <div class="row" id="myfrm2">
			...
			<div class="col-lg-12"> <?php 
                ...
                <h3 style="text-align: center; margin: 10px 0px;">[See rule 13 (2) (ii)]</h3>
                <h3 style="text-align: center; margin: 10px 0px;">INFORMED CONSENT FORM FOR THE DONOR OF SPERM</h3>
                <form action="" enctype="multipart/form-data" method="post">
                    <table width="100%" class="">
                        <tbody>
                            <tr>
                                <td colspan="3" style="padding: 10px 10px;">
                                    I, Mr. <span id="username" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name" value="" style="border: 0px; width: 350px;" /></span> , Address
                                    ...
                                    <span id="username4" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name4" value="" style="border: 0px; width: 350px;" /></span> Willingly consent to donate my sperm to
                            ...
                            <tr>
                                <td colspan="3" style="padding: 10px 10px;">
                                    ...
                                    address of the clinician) on <span id="username6" style="border-bottom: 1px dotted;"><input type="date" name="name" id="name6" value="" style="border: 0px; width: 200px;" /></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" style="padding: 10px 10px;">
                                    ...
                                    independent counsellor) on <span id="username8" style="border-bottom: 1px dotted;"><input type="date" name="name" id="name8" value="" style="border: 0px; width: 250px;" /></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" style="padding: 10px 10px;">
                                    (I understand that there will be no direct or indirect contact between the recipient, and me, and my personal identity will not be disclosed to the recipient or to the child born through the use of my
                                    gamete:)
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="3" style="padding: 9px 10px;">
                                    Signature of Donor <span id="username9" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name9" value="" style="border-bottom: 1px dotted;border-top:0px;border-left:0px;border-right:0px;width: 250px;" /></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" style="padding: 9px 10px;">Endorsement by the ART bank</td>
                            </tr>
                            <tr>
                                <td colspan="3" style="padding: 9px 10px;">
                                    I/we have personally explained to <span id="username10" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name10" value="" style="border: 0px; width: 350px;" /></span> the details and
                                    implications of his signing this consent / approval form, and made sure to the extent humanly possible that he understands these details and implications.
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" style="padding: 9px 10px;">
                                    Name and signature of the Doctor <span id="username11" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name11" value="" style="border-bottom: 1px dotted;border-top:0px;border-left:0px;border-right:0px;width: 250px;" /></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" style="padding: 9px 10px;">
                                    Name, address and signature of the Witness from the ART bank <span id="username12" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name12" value="" style="border-bottom: 1px dotted;border-top:0px;border-left:0px;border-right:0px;width: 250px;" /></span>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" style="padding: 9px 10px;">
                                    Name and address of the ART bank <span id="username13" style="border-bottom: 1px dotted;"><input type="text" name="name" id="name13" value="" style="border: 0px; width: 350px;" /></span>
                                </td>
                            </tr>
                           <tr>
