...
<script type="text/javascript">
$(document).ready(function() {
    // Initialize standard multiselect behaviors
    ...
    // 1. PROCEDURE SUGGESTION TOGGLE (Handles both unique input IDs)
    ...
    // 4. PROVISIONAL DIAGNOSIS TOGGLE
    ...
    // Check configuration state safely after a brief delay for UI initialization
    setTimeout(function() {
...
<script type="text/javascript">
// 3. FIXED: INVESTIGATION SUGGESTION TOGGLE (Actual System Element Target IDs)
    $("#investigation_suggestion").change(function() {
        // Aapke HTML block me dynamic entries ka real container IDs ye dono hain
        ...
        if(this.checked) {
            ...
            // Re-bind global internal array state values if window objects are set from database
            if(typeof window.female_minvestigation_suggestion_list_values !== 'undefined' && window.female_minvestigation_suggestion_list_values.length > 0) {
            ...
            if(typeof window.male_minvestigation_suggestion_list_values !== 'undefined' && window.male_minvestigation_suggestion_list_values.length > 0) {
