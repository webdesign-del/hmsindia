...
public function get_unread_notifications() {
    ...
    public function get_filtered_transfers($filters = array(), $limit = null, $offset = 0) {
        $this->db->select('
            ...
            sti.quantity_transferred, sti.quantity_received, sti.unit_price,
            (sti.quantity_transferred / IF(m.pack_size > 0, m.pack_size, 1) * mb.mrp) AS total_mrp_price,
            (sti.quantity_transferred / IF(m.pack_size > 0, m.pack_size, 1) * mb.purchase_price) AS calculated_price
        ');
